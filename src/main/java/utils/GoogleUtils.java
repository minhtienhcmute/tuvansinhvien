...
//    private final static String GOOGLE_REDIRECT_URI = "http://localhost:8080/auth/callback";
    private final static String GOOGLE_REDIRECT_URI = "http://localhost:8080/_03_final_project_war/auth/callback";
