...
<form id="categoryForm" action="category?action=edit" method="post">
    <input type="hidden" name="id" value="${category.id}"/> <!-- chỉ dùng nếu là edit -->

    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3 row">
                <label for="name-input" class="col-sm-2 col-form-label text-end">Category name</label>
                <div class="col-sm-10">
                    <input required name="name" class="form-control" type="text"
                           value="${category.name}" placeholder="Input category name" id="name-input">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="example-password-input" class="col-sm-2 col-form-label text-end">Description</label>
                <div class="col-sm-10">
                    <input value="${category.description}" name="desc" class="form-control" type="text"
