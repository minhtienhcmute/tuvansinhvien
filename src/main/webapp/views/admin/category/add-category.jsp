...
<form id="categoryForm" action="category?action=add" method="post">
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input required name="name" class="form-control" type="text"
                           placeholder="Input category name" id="name-input">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="example-password-input" class="col-sm-2 col-form-label text-end">Description</label>
                <div class="col-sm-10">
                    <input name="desc" class="form-control" type="text" id="example-password-input">
                </div>
            </div>
        </div>
