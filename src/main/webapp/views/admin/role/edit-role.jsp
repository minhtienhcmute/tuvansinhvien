...
<form id="permissionForm" action="role?action=edit" method="post">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input required value="${role.name}" name="name" type="text" class="form-control" id="horizontalInput1"
                    ...
                    <tr>
                        ...
                        <td>
                            <c:forEach var="perm" items="${entry.value}">
                                ...
                                <c:if test="${not empty currentPermissions[entry.key]}">
                                    <c:forEach var="currPerm" items="${currentPermissions[entry.key]}">
                                        <c:if test="${currPerm.id == perm.id}">
