        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/logos/logo-sm.png" alt="Logo" height="50"
                        alt="" class="me-1">
                </a>
                        ...
                        <c:choose>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end py-0">
                                        <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                                            ...
                                            <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                <h6 class="my-0 fw-medium text-dark fs-13">${sessionScope.user.name}
                                                </h6>
                                            </div><!--end media-body-->
                                        </div>
                                        ...
                                        <%-- <small class="text-muted px-2 py-1 d-block">Settings</small>--%>
                                            <%-- <a class="dropdown-item" href="pages-profile.html"><i--%>
                                                    <%-- class="las la-cog fs-18 me-1 align-text-bottom"></i>Account
                                                        Settings</a>--%>
                                                        <%-- <a class="dropdown-item" href="pages-profile.html"><i--%>
                            ...
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/login"
                                    class="btn btn-primary dropdown-toggle" type="button" id="signInButton">
                                    Sign in
                                </a>
                            </c:otherwise>
                        </c:choose>
